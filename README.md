...
- Windows: [CafeKiosk-Windows-Setup-1.2.6.exe](https://github.com/ljwoo8942/cafe_kiosk_rpi_windows_open/releases/download/v1.2.6/CafeKiosk-Windows-Setup-1.2.6.exe)
- Raspberry Pi 더블클릭 설치: [CafeKiosk-RPi-Installer-1.2.6.zip](https://github.com/ljwoo8942/cafe_kiosk_rpi_windows_open/releases/download/v1.2.6/CafeKiosk-RPi-Installer-1.2.6.zip)
- Raspberry Pi 직접 설치: [cafe-kiosk-rpi_1.2.6_all.deb](https://github.com/ljwoo8942/cafe_kiosk_rpi_windows_open/releases/download/v1.2.6/cafe-kiosk-rpi_1.2.6_all.deb)
- Windows 무설치 압축본: [CafeKiosk-Windows-Portable-1.2.6.zip](https://github.com/ljwoo8942/cafe_kiosk_rpi_windows_open/releases/download/v1.2.6/CafeKiosk-Windows-Portable-1.2.6.zip)

릴리즈 페이지:
[Cafe Kiosk v1.2.6](https://github.com/ljwoo8942/cafe_kiosk_rpi_windows_open/releases/tag/v1.2.6)

## 설치 방법

Windows:

1. `CafeKiosk-Windows-Setup-1.2.6.exe`를 다운로드합니다.
2. 설치 파일을 실행합니다.
...
1. `CafeKiosk-RPi-Installer-1.2.6.zip`을 다운로드합니다.
2. 압축을 풉니다.
...
1. `cafe-kiosk-rpi_1.2.6_all.deb`를 다운로드합니다.
2. 파일이 있는 폴더에서 아래 명령을 실행합니다.

```bash
sudo apt install ./cafe-kiosk-rpi_1.2.6_all.deb
cafe-kiosk
```
